...
public class PermissionCheckActivity extends AppCompatActivity  { //implements GeoTask.Geo, LocationListener
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (strTo != null) {
            ...
            new GeoTask(PermissionCheckActivity.this).execute(url);  //JSONデータ処理
    ...
    public void toClick(View view){
        //テキスト入力のView
        final EditText editView = new EditText(PermissionCheckActivity.this);
        new AlertDialog.Builder(PermissionCheckActivity.this)
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        //入力した文字をトースト出力する
                        Toast.makeText(PermissionCheckActivity.this,
